...
lmic_printf("Se ejecuto processRxDnData \n");
    if( LMIC.dataLen == 0 ) {
        LMIC.txrxFlags = 0;  // nothing in 1st/2nd DN slot
...
lmic_printf("Se ejecuto setupRx2DnData \n");
...
lmic_printf("Se ejecuto processRx1DnData \n");
...
lmic_printf("Se ejecuto setupRx1DnData \n");
    setupRx1(FUNC_ADDR(processRx1DnData));
}


static void updataDone (xref2osjob_t osjob) {
lmic_printf("Se ejecuto updataDone \n");
...
lmic_printf("Se ejecuto buildDataFrame \n");
...
lmic_printf("Se ejecuto processDnData \n");
