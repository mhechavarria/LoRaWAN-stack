...
//ByA El siguiente bloque lo lleve al sx1276.h
...
DioIrqHandler *DioIrq[] = { SX1276OnDio0Irq, SX1276OnDio1Irq,
                            ...
                            NULL, NULL }; //ByA saque el SX1276OnDio4Irq
...
void SX1276Init( RadioEvents_t *events )
{
    ...
    {
        SX1276SetModem( RadioRegsInit[i].Modem ); //Configura el registro de Radio (Modo "FSK-LORA"/Direccion/Valor)
    ...
    case MODEM_FSK:
        {
        	...
        	//Cambie round() por ceil() supuestamente redondea UP
...
void SX1276SetModem( RadioModems_t modem )
{
    ...
    case MODEM_FSK:
        SX1276SetSleep( );
uint8_t SIMPLIFICACION_1=(( SX1276Read( REG_OPMODE ) & RFLR_OPMODE_LONGRANGEMODE_MASK ) | RFLR_OPMODE_LONGRANGEMODE_OFF);
        SX1276Write( REG_OPMODE,SIMPLIFICACION_1);
    ...
    case MODEM_LORA:
        SX1276SetSleep( );
uint8_t SIMPLIFICACION_2=((SX1276Read( REG_OPMODE ) & RFLR_OPMODE_LONGRANGEMODE_MASK ) | RFLR_OPMODE_LONGRANGEMODE_ON);
        SX1276Write( REG_OPMODE,SIMPLIFICACION_2);
        SX1276Write( REG_DIOMAPPING1, 0x00 );
    ...
    switch( SX1276.Settings.State )
    {
        case RF_RX_RUNNING:
            ...
            case MODEM_FSK:
                ...
                if( SX1276.DIO4.portIndex == 0x0000 )
                {
