...
*/
//Mi version
//#define GPIO_PIN(n) ((n)&0xFu) //n=|Pue|Pue|Pue|Pue|Pue|Pin|Pin|Pin| quiero solo los tres ultimos que son del pin
//#define GPIO_PORT(n) ((n>>12U)&0xFu)  //n=|Pue|Pue|Pue|Pue|PUERTO-1|Pin|Pin|Pin| quiero solo los 5 primeros que son del puerto
//#define GPIO(port, pin) (port + pin)
//Mi new version
#define GPIO_PIN(n) ((n)&0x1Fu) //n=|Pue|Pue|Pue|Pue|Pue|Pin|Pin|Pin| quiero solo los tres ultimos que son del pin
#define GPIO_PORT(n) ((n>>12U)&0x1Fu)  //n=|Pue|Pue|Pue|Pue|PUERTO-1|Pin|Pin|Pin| quiero solo los 5 primeros que son del puerto
#define GPIO(port, pin) (port + pin)
