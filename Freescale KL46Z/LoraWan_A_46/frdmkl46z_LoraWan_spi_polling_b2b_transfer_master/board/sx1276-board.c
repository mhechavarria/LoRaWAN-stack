...
// #define USE_RADIO_DEBUG //No Defino los led de debug
...
#if defined( USE_RADIO_DEBUG )
    GpioInit( &DbgPinTx, RADIO_DBG_PIN_TX, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 1 );
    GpioInit( &DbgPinRx, RADIO_DBG_PIN_RX, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 1 );
#endif
...
void SX1276IoIrqInit( DioIrqHandler **irqHandlers )
{
	...
	//estos ya estan configurados en el pin_mux.c
    PORT_SetPinInterruptConfig(PORTA, SX1276.DIO0.pin, kPORT_InterruptRisingEdge);
    PORT_SetPinInterruptConfig(PORTA, SX1276.DIO1.pin, kPORT_InterruptRisingEdge);
    PORT_SetPinInterruptConfig(PORTA, SX1276.DIO2.pin, kPORT_InterruptRisingEdge);
    PORT_SetPinInterruptConfig(PORTA,SX1276.DIO3.pin, kPORT_InterruptRisingEdge);
