    ...
    while( macIndex < commandsSize )
    {
        ...
        switch( payload[macIndex++] )
        {
            ...
            case SRV_MAC_DEVICE_TIME_ANS:
            {
                ...
                printf("gps sec= %d y gps subsec= %d",gpsEpochTime.Seconds,gpsEpochTime.SubSeconds);
...
static LoRaMacStatus_t ScheduleTx( bool allowDelayedTx )
{
    ...
    else
    {
        ...
        MacCtx.RxWindow1Delay = 300; //MacCtx.NvmCtx->MacParams.ReceiveDelay1 + MacCtx.RxWindow1Config.WindowOffset;
