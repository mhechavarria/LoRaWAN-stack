...
//	// printf("COUNT= %d second= %d ticks= %d",COUNT,seconds,ticks);
//	 *milliseconds = ( ticks ); //RtcTick2Ms()
//	 return seconds;

	 double numero_flotante;
	 uint32_t entero_numero_flotante;

	 numero_flotante=COUNT/(1000U);
	 entero_numero_flotante = numero_flotante; //entero, segundos
	// numero_flotante = numero_flotante - entero_numero_flotante;//milisegundos
	 *milliseconds =COUNT%1000;
	// printf("count= %d, sec= %d, mili= %d",COUNT,entero_numero_flotante,*milliseconds);
	 return entero_numero_flotante;
}
