...
bool RegionAU915RxConfig( RxConfigParams_t* rxConfig, int8_t* datarate )
{
    ...
    // Radio configuration rxConfig->WindowTimeout
    Radio.SetRxConfig( MODEM_LORA, rxConfig->Bandwidth, phyDr, 1, 0, 8,400 , false, 0, false, 0, 0, true, rxConfig->RxContinuous );

    //printf("@@@Configuracion RX; Freq=%d, Bandwidth=%d , DR=%d , WindowsTimeout=%d \n",frequency,rxConfig->Bandwidth,phyDr,rxConfig->WindowTimeout);
